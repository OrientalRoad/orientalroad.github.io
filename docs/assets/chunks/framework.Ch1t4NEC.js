...
function createRouter(loadPageModule, fallbackComponent) {
  ...
  const router = {
    ...
    async go(href, options) {
      ...
      await ((_b = router.onAfterRouteChange) == null ? void 0 : _b.call(router, href));
    }
  };
  ...
  if (inBrowser) {
    ...
    window.addEventListener("popstate", async (e) => {
      ...
      syncRouteQueryAndHash();
      await ((_a = router.onAfterRouteChange) == null ? void 0 : _a.call(router, href));
    });
...
export {
  ...
  watchEffect as N,
  onUnmounted as O,
  watchPostEffect as P,
  EXTERNAL_URL_RE as Q,
  resolveDynamicComponent as R,
  mergeProps as S,
  Teleport as T,
  toHandlers as U,
  withKeys as V,
  onBeforeUnmount as W,
  useScrollLock as X,
  withModifiers as Y,
  inBrowser as Z,
  _export_sfc as _,
  readonly as a,
  getScrollOffset as a0,
  onContentUpdated as a1,
  useRoute as a2,
  onKeyStroke as a3,
  ...
  defineClientComponent as a8,
  provide as a9,
  useLocalStorage as aA,
  watchDebounced as aB,
  useRouter as aC,
  useEventListener as aD,
  markRaw as aE,
  createApp as aF,
  escapeRegExp as aG,
  createSlots as aa,
  ...
  unrefElement as av,
  notNullish as aw,
  tryOnScopeDispose as ax,
  computedAsync as ay,
  useSessionStorage as az,
