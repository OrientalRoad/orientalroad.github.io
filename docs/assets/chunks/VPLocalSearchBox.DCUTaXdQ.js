...
import { a6 as __vitePreload, s as shallowRef, f as computed, t as toValue, au as toArray, av as unrefElement, aw as notNullish, w as watch, ax as tryOnScopeDispose, j as defineComponent, ay as computedAsync, r as ref, az as useSessionStorage, aA as useLocalStorage, N as watchEffect, aB as watchDebounced, o as onMounted, n as nextTick, a3 as onKeyStroke, aC as useRouter, aD as useEventListener, X as useScrollLock, Z as inBrowser, W as onBeforeUnmount, C as createBlock, m as openBlock, x as createBaseVNode, Y as withModifiers, as as withDirectives, u as unref, at as vModelText, i as isRef, l as createElementBlock, q as createCommentVNode, v as normalizeClass, y as renderList, F as Fragment, A as createTextVNode, z as toDisplayString, T as Teleport, aE as markRaw, aF as createApp, ae as dataSymbol, aj as pathToFile, aG as escapeRegExp, _ as _export_sfc } from "./framework.Ch1t4NEC.js";
import { X as useData, Y as createSearchTranslate } from "./theme.BvkY57QZ.js";
const localSearchIndex = { "root": () => __vitePreload(() => import("./@localSearchIndexroot.CmWMrpFu.js"), true ? [] : void 0), "ja": () => __vitePreload(() => import("./@localSearchIndexja.Deed6QEh.js"), true ? [] : void 0) };
/*!
* tabbable 6.2.0
...
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f6475fba"]]);
export {
